...
@section('content')
    ...
    <div class="carrossel-container">
        <div class="carrossel" id="carrossel">
            <img src="{{ asset('fotos/imagem7.jpg') }}" class="slide active" alt="Imagem 1">
            <img src="{{ asset('fotos/farmacia.jpg') }}" class="slide" alt="Imagem 2">
            <img src="{{ asset('fotos/labor.jpg') }}" class="slide" alt="Imagem 3">
            <img src="{{ asset('fotos/student-750-300.jpg') }}" class="slide" alt="Imagem 4">
    ...
    <div class="news-section">
        <div class="news-card">
            <div class="news-image">
                <img src="{{ asset('images/1.jpg') }}" alt="Notícia 1">
            </div>
    ...
    <section id="gps">
        <img src="{{ asset('fotos/mapa-do-mundo.jpg') }}" alt="mapa mundo">
    </section>
