...
<link rel="stylesheet" href="<?php echo e(asset('css/formulario4.css')); ?>">
...
<body>
    ...
    <div class="container">
        ...
        <div class="upload-container">
            <label for="bi_pdf" class="custom-upload">
                <img src="<?php echo e(asset('fotos/upload-file.png')); ?>" alt="Upload" class="upload-icon-img">
                <span class="upload-text">Fotocópia colorida do B.I.</span>
            ...
            <label for="inarees_pdf" class="custom-upload">
                <img src="<?php echo e(asset('fotos/upload-file.png')); ?>" alt="Upload" class="upload-icon-img">
                <span class="upload-text">Fotocópia da Declaração do INAREES</span>
            ...
            <label for="diploma_pdf" class="custom-upload">
                <img src="<?php echo e(asset('fotos/upload-file.png')); ?>" alt="Upload" class="upload-icon-img">
                <span class="upload-text">Fotocópia do Diploma ou Certificado</span>
    ...
    document.getElementById('btnSeguinte').addEventListener('click', () => {
        window.location.href = "<?php echo e(url('/formulario5')); ?>";
    });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mayombe Digital\OneDrive\Documents\estudos\projecto_tio_armando\ofa\resources\views/formulario4.blade.php ENDPATH**/ ?>