...
<?php $__env->startSection('title', 'OFA-home'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="carrossel-container">
        <div class="carrossel" id="carrossel">
            <img src="<?php echo e(asset('fotos/imagem7.jpg')); ?>" class="slide active" alt="Imagem 1">
            <img src="<?php echo e(asset('fotos/farmacia.jpg')); ?>" class="slide" alt="Imagem 2">
            <img src="<?php echo e(asset('fotos/labor.jpg')); ?>" class="slide" alt="Imagem 3">
            <img src="<?php echo e(asset('fotos/student-750-300.jpg')); ?>" class="slide" alt="Imagem 4">
            <img src="<?php echo e(asset('fotos/imagem.jpg')); ?>" class="slide" alt="Imagem 5">
            <img src="<?php echo e(asset('fotos/imagem4.jpg')); ?>" class="slide" alt="Imagem 6">
            <img src="<?php echo e(asset('fotos/fisiot.jpg')); ?>" class="slide" alt="Imagem 7">
            <img src="<?php echo e(asset('fotos/practise.jpg')); ?>" class="slide" alt="Imagem 8">
        </div>
    ...
    <div class="news-section">
        <div class="news-card">
            <div class="news-image">
                <img src="<?php echo e(asset('images/1.jpg')); ?>" alt="Notícia 1">
            </div>
        ...
        <div class="news-card">
            <div class="news-image">
                <img src="<?php echo e(asset('images/2.jpg')); ?>" alt="Notícia 2">
            </div>
            <p class="news-description">
                Comissão Instaladora
                <br><br><br><br><br>
        ...
        <div class="news-card">
            <div class="news-image">
                <img src="<?php echo e(asset('images/7.jpg')); ?>" alt="Notícia 1">
            </div>
            <p class="news-description">
                Comissão Instaladora
                <br><br><br><br><br>
    ...
    <section id="amarela">
        <div id="image">
            <img src="<?php echo e(asset('fotos/imagem4.jpg')); ?>" alt="Notícia 1">
        </div>
        <div id="conteudo">    
    ...
    <section id="gps">
        <img src="<?php echo e(asset('fotos/mapa-do-mundo.jpg')); ?>" alt="mapa mundo">
    </section>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mayombe Digital\OneDrive\Documents\estudos\projecto_tio_armando\ofa\resources\views/home.blade.php ENDPATH**/ ?>